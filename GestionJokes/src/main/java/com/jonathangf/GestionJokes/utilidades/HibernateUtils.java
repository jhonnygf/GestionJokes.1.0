...
/**
 * Clase que contiene los métodos necesarios para realizar las operaciones con la base de datos con Hibernate de forma sencilla.
 */
public class HibernateUtils {
	...
	/**
	 * Método que abre la conexión con la base de datos y devuelve si se ha realizado correctamente
	 * @return
	 */
	...
	/**
	 * Método que cierra la conexión con la base de datos y libera los recursos
	 */
	...
	/**
	 * Método que quita los logs de Hibernate para que no se muestren por pantalla
	 */
	...
	/**
	 * Método que quita los logs de Hibernate
	 */
	...
	/**
	 * Dado una lista de Objetos que le enviamos lo guarda en la base de datos de forma individual y no en bloque como el anterior
	 * @param objects
	 * @return
	 */
